...
async def ask_chatgpt(question):
    ...
    try:
        ...
        system_content += (
            ...
            "3. Отвечай КОНКРЕТНО на вопрос клиента, используя данные из @bahur_data.txt\n"
            ...
            "8. Пиши коротко, красиво, ясно, со стилем, используй смайлы, твоя основа это только данные которые есть в bahur_data.txt без фантазий и выдумок\n"
            ...
            "14. КРИТИЧЕСКИ ВАЖНО: ВСЕ ответы и данные о парфюмерии, заказах, доставке, ценах, условиях, фабриках, ароматах БЕРИ ТОЛЬКО из bahur_data.txt! НЕ используй никакие другие источники информации! НЕ выдумывай фабрики, ароматы, цены! 🚨\n"
            ...
            "17. ФАБРИКИ: у нас только EPS (Турция), SELUZ (Турция), LUZI (Швейцария). Категории качества, TOP, Q1, Q2. НЕ выдумывай проценты качества! НЕ выдумывай другие фабрики!\n"
            "18. При упоминании ароматов, предлагай перейти в раздел ноты\n"
            "19. НЕЛЬЗЯ: выдумывать проценты качества, выдумывать фабрики, выдумывать ароматы, выдумывать цены. Если информации нет в bahur_data.txt - говори 'не знаю'!"

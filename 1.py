...
async def ask_chatgpt(question):
    ...
    try:
        ...
        example_block = """
ПРИМЕР ОТВЕТА:
🎯 Аромат: Vanilla Delight
🏭 Фабрика: TOP
⭐ Качество: Premium
💰 Цена: 1500 руб за 50 мл
🌱 Верхние ноты: Ваниль, Карамель
🌿 Средние ноты: Сливки, Мед
🍃 Базовые ноты: Мускус, Древесина
📋 Описание: Нежный и сладкий аромат с нотками ванили и карамели
🔗 Ссылка: <a href='http://clck.ru/jrimp'>Прайс-лист</a>
"""

...
async def ask_chatgpt(question, user_id=None):
    try:
        ...
        system_content = (
            ...
            "ПРАВИЛА ОТВЕТОВ:\n"
            "1. При написании названия важно: только ароматов, - каждое слово пиши с большой буквы\n"
            "2. Вставляй красивый и интересный смайлик в начале кнопки, когда делаешь кнопки.\n"
            "3. Отвечай КОНКРЕТНО на вопрос клиента\n"
            "3.1 Отвечай на вопросы из bahur_data когда вопрос клиента на 50% и более связан с вопросами из bahur_data"
            ...
            "8.1 Старайся отвечать максимально коротко и кратко"

        ...
        if include_prices:
            ...
            for col, volume, volume_text in price_ranges:
                ...
                if price_per_g and not pd.isna(price_per_g):
                    ...
                    info += f"💧{volume_text} = {total_price}₽ ({price_per_g}₽/GR)\n"
...
async def ask_chatgpt(question):
    ...
    try:
        ...
        system_content = (
            ...
            "Ты веселый, дружелюбный и общительный медвежонок, который любит шутить и помогать людям! 🐻\n"
            ...
            "⚔️ TOP VERSION: [фабрика качество: процент% | фабрика качество: процент%] (только если есть >1 версии)\n"
        ...
        system_content += (
            ...
            "24. Всегда используй юмор и смайлы! Отвечай как веселый медвежонок, а не как скучный учебник\n"
            "25. На вопросы про изготовление спреев отвечай кратко и с юмором, не давай длинных инструкций\n"
            "26. Не упоминай алкоголь или другие химические вещества в контексте ароматов\n"
            "27. Будь кратким и по делу, не растягивай ответы на целые параграфы\n"
        )

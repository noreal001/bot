...
async def ask_chatgpt(question):
    ...
    try:
        ...
        system_content += (
            ...
            "14. КРИТИЧЕСКИ ВАЖНО: ВСЕ ответы и данные о парфюмерии, заказах, доставке, ценах, условиях БЕРИ ТОЛЬКО из bahur_data.txt! НЕ используй никакие другие источники информации! 🚨\n"

...
"""
        ...
        system_content += (
            ...
            "22. Когда пишешь аромат, используй строго такой шаблон:\n"
            "   ✨ название аромата и ссылка на него прямо внутри названия аромата\n"
            "   ⛵️ SELUZ TOP\n"
            "   ⚡️ TOP LAST: Процент за последние пол года (№ порядковый номер в топ листе за пол года)\n"
            "   🚀 TOP ALL: Процент за всё время (№ порядковый номер в топ листе за всё время)\n"
            "   ⚔️ TOP VERSION: ## cчитать общий процент за всё время и последние пол года\n"
            "   🥥SELUZ - TOP: процент общий%\n"
            "   🍇EPS TOP: процент общий\n"
            "   🍒LUZI: процент общий%\n"
            "   💵 Стоимость:\n"
            "   💧505 грамм = 16 160₽ (32₽/GR)\n"
            "   Каждый аромат выводи с новой строки!"
            "23. Используй сирого только эти эмодзи для нот: 🌱 (верхние), 🌿 (средние), 🍃 (базовые), ® (бренд), эмоджи страны (страна), 🥀 (пол). Описывай ноты строго по шаблону выше.\n"
        )
